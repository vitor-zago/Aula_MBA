"""
API de Detecção de Fraude - SEM TESTES
Arriscado: Não há validação automática!
"""

from fastapi import FastAPI
from pydantic import BaseModel

app = FastAPI(title="API Fraude - Sem Testes")
...
@app.get("/")
def root():
    return {"status": "API rodando", "versao": "1.0-sem-testes"}
